        ...
        <form action="insert.do" method="post" name="userInfo" onsubmit="return checkValue()">
			<table align="center">
				...
				<tr>
					...
					<td><input class="span5" type="text" name="user_name" required></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input class="span5" type="text" name="user_addr" required></td>
				</tr>
				<tr>
					<td><p><font color="black">전화번호</font></p></td>
					<td><input class="span5" type="text" name="user_tel" required></td>
				</tr>
				<tr>
					<td><p><font color="black">나이</font></p></td>
					<td><input class="span5" type="text" name="user_age" required></td>
				</tr>
				<tr>
					<td><p><font color="black">이메일</font></p></td>
					<td><input class="span5" type="email" name="user_email" required></td>
				</tr>
				<tr>
