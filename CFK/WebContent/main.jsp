        ...
        <div id="contact" class="contact">
            ...
            <div class="triangle"></div>
                ...
                <div class="map-wrapper">
                	<div style="width:50%;float:left;"><img src="./Resources/images/show.PNG" width="500" alt="show"></div>
                    <div style="width:50%;float:left;">
                     <iframe src="map.html" frameborder="0" width="700px" height="600px" id="" title="방청권 신청 프레임"></iframe>
                    </div> 
                </div>    
                </div>
                <div class="container">
